...
function addTask() {
    ...
    // item.
    $(".tasks").append(item);
    $(".tasks li").last().append("<div><button class = 'task_edit' ><img src='assets/edit.svg' alt='edit svg'></button><button class='task_delete' ><img src='assets/delete.svg' alt='delete svg'></button></div>")
    textarea_.val('');
    textarea_.height('');
    var myElement = $('.tasks');
    ...
    $('.task_edit').on('click',function(){
        ...
        var input = $('<input type="text" autocomplete="off" maxlength=200 class="taskedit">').val(span.text());
    ...
    $('.addlist').on({
        keydown: function (e) {
            ...
            if (e.key === 'Enter') {
                ...
                $('.lists').append(item);
                $(".lists li").last().append("<div><button class = 'task_edit' ><img src='assets/edit.svg' alt='edit svg'></button><button class='task_delete'><img src='assets/delete.svg' alt='delete svg'></button></div>")
